...
def register_auto_reply(client):
    """Регистрирует авто-ответ на 'работа'."""
    
    @client.on(events.NewMessage(outgoing=True))
    async def auto_reply(event):
        if "работа" in event.message.text.lower():
            ...
            if images:
                ...
                print(f"Reply to 'work' c picture")
            else:
                await event.respond(random_text)
                print(f"Ответ на 'работа' без картинки (нет файлов в папке)")
